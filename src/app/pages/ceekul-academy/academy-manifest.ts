// Academy section manifest — metadata only, no component imports.
// Replace the LOCAL_MANIFEST fallback with an API call when the backend
// exposes GET /api/academy/manifest to enable server-driven section rollout.
...
export const ACADEMY_MANIFEST: AcademySection[] = [
  {
    id: 'vision-council',
...
export const ACADEMY_DEFAULT: AcademySection = {
  id: 'academy',
